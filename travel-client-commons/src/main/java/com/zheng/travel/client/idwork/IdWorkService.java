package com.zheng.travel.client.idwork;

import com.zheng.travel.client.utils.idworker.IdWorker;
import com.zheng.travel.client.utils.idworker.WorkerIdStrategy;
import com.zheng.travel.client.utils.idworker.utils.Utils;
import com.zheng.travel.client.utils.idworker.strategy.DefaultWorkerIdStrategy;
...
public class IdWorkService {
    ...
    public static void main(String[] args) {
		String aa = new IdWorkService().nextShort();
		String bb = new IdWorkService().next();
